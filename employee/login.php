    ...
    <div class="row" style="width: 100%;">
        <div class="col-md-12 mx-5 my-5">
            <div class="titlepage mx-auto">
                <h1 class="display-1 font-weight-bold text-success text-center">Welcome to Hospital's Login</h1>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            ...
            if (isset($_POST['button'])) {
                ...
                $q = "select * from `hospital` where `email`='$email' and `password`='$password'";
                $result = mysqli_query($conn, $q);
                if (mysqli_num_rows($result) > 0) {
                    //login
                    $data = mysqli_fetch_assoc($result);
                    $_SESSION['hospital_id'] = $data['id'];
            ...
            <div class="col-lg-6">
                <form class="form-contact contact_form" action="" method="post" id="request" novalidate="novalidate" enctype="multipart/form-data">
                    ...
                    <div class="form-group mt-3 col-12">
                        <button type="submit" name = "button" class="valid border border-success button button-contactForm boxed-btn">Send</button>
                    </div>
                </form>
            </div>
            <div class="col-lg-3">
