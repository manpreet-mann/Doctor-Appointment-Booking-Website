                    ...
                    <form class="form-contact contact_form" action="" method="post" id="request" novalidate="novalidate" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group mx-auto col-12">
                                <button name="btn" class="valid border border-success button button-contactForm boxed-btn">Search</button>
                            </div>
                        </div> -->
                        <?php
                        require "../config.php";
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $data['opentiming'] ?></td>
                                            <td><?php echo $data['closetiming'] ?></td>
                                            <td><a href="edit_hospital.php ?id=<?php echo $data['id']; ?>" <button type="button" class="valid border border-success button button-contactForm boxed-btn">Edit</button></a></td>
                                            <td><a href="delete_hospital.php?id=<?php echo $data['id']; ?>" onclick="return confirm('Are you sure you want to delete this item?');" class="text-danger"><button type="button" class="valid border border-success button button-contactForm boxed-btn">Delete</button>
                                                </a></td>
